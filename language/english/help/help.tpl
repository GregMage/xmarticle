<div id="help-template" class="outer">
    <h1 class="head">Help:
        <a class="ui-corner-all tooltip" href="<{$xoops_url}>/modules/xmarticle/admin/index.php"
           title="Back to the administration of xmarticle"> article
            <img src="<{xoAdminIcons 'home.png'}>"
                 alt="Back to the Administration of xmarticle">
        </a></h1>
