...
CREATE TABLE `xmarticle_article` (
  ...
  `article_douser`         tinyint(1)  unsigned    NOT NULL DEFAULT '1',
  `article_dodate`         tinyint(1)  unsigned    NOT NULL DEFAULT '1',
  `article_domdate`        tinyint(1)  unsigned    NOT NULL DEFAULT '1',
  `article_dohits`         tinyint(1)  unsigned    NOT NULL DEFAULT '1',
